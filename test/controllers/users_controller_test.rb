...
class UsersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create user" do
    assert_difference('User.count') do
      post users_url, params: { user: { email: @user.email, name: @user.name, nickname: @user.nickname, password_digest: @user.password_digest, provider: @user.provider, uid: @user.uid } }, as: :json
    end
